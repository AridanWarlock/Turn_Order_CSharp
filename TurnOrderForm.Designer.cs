namespace TurnOrder
{
    partial class TurnOrderForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            damageComboBox = new ObserverComboBox();
            label13 = new Label();
            groupBox4 = new GroupBox();
            initChangeText = new TextBox();
            label10 = new Label();
            initChangeButton = new Button();
            initChangeComboBox = new ObserverComboBox();
            label9 = new Label();
            ...
            deleteComboBox = new ObserverComboBox();
            label12 = new Label();
            label3 = new Label();
        ...
        private ObserverComboBox damageComboBox;
        ...
        private ObserverComboBox initChangeComboBox;
        ...
        private ObserverComboBox deleteComboBox;
